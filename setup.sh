#!/bin/bash
# Run with: yes Y | sh entry_point.sh
...
sudo curl -L "https://github.com/docker/compose/releases/download/1.26.2/docker-compose-s)-$(uname -m)" -o /usr/loc
al/bin/docker-compose
